...
(function() {
  ...
  var scenes = data.scenes.map(function(data) {
    ...
    data.infoHotspots.forEach(function(hotspot) {
      ...
      var offsetPitch = -0.08; // Ajuste a posição lateral do ícone de câmera
      scene.hotspotContainer().createHotspot(cameraElement, {
        yaw: hotspot.yaw, 
        pitch: hotspot.pitch + offsetPitch
      });
    });
  ...
  function createCameraHotspotElement(hotspot) {
    ...
    wrapper.addEventListener('click',function() {
      var imgSrc = hotspot.image ? 'img/' + hotspot.image : 'img/camera-default.jpg';
